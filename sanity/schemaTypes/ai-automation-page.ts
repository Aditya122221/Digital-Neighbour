...
export const aiAutomationPage = defineType({
  ...
  title: "AI & Automation Service Page",
  type: "document",
  groups: [
    {
      name: "basic",
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Service Name",
      type: "string",
      description: "Display name for this AI & Automation service",
      group: "basic",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: "array",
          description:
            "Fallback hero images (3 images) used by other AI & Automation pages when they don't upload their own images.",
          of: [{ type: "image", options: { hotspot: true } }],
          validation: (Rule) => Rule.max(3).min(3),
          hidden: ({ document }) => document?.slug?.current !== "ai-automation",
        }),
        defineField({
          name: "heroImages",
          title: "Hero Images",
          ...
          of: [
            {
              ...
              fields: [
                ...
                defineField({
                  ...
                  title: "Icon",
                  type: "string",
                  description: "Icon identifier (e.g., 'shield', 'cloudCog')",
                }),
                defineField({
                  name: "details",
                  title: "Details",
    ...
    defineField({
      ...
      type: "string",
      group: "services",
      description: "Main service name (e.g., 'AI & Automation')",
    }),
  ...
  preview: {
    ...
    prepare({ title, subtitle }) {
      return {
        title: title || "Untitled AI & Automation Service",
