      ...
      <div className="container mx-auto px-5">
        <div className="w-full lg:w-2/3 mx-auto text-center">
          ...
          <p className="rfs:text-xl font-light mb-4">
            ...
            multitude of diverse industry backgrounds.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-5">
          <div className="flex flex-wrap gap-y-4 md:gap-y-10 -mx-2 md:-mx-5">
            {[
              {
                title: "Real Estate",
                icon: "i-material-symbols:real-estate-agent-outline",
              ...
              {
                title: "Travel",
                icon: "i-material-symbols:travel",
              ...
              {
                title: "E-commerce",
                icon: "i-fluent-mdl2:shop-server",
              ...
              {
                title: "Hospitality",
                icon: "i-emojione-monotone:hotel",
              ...
              {
                title: "Manufacturing",
                icon: "i-fluent-emoji-high-contrast:factory",
              ...
              >
                <div className="bg-[#212121] text-center flex flex-col items-center justify-center px-4 h-full group relative rounded-md">
                  <div className="md:group-hover:opacity-0 py-6 md:py-0 md:absolute">
                    <span
                      className={`iconify ${icon} rfs:text-7xl mb-3 text-theme-purple`}
                      aria-hidden="true"
                    />
