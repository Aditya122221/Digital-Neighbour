...
export default function OtherServices() {
	...
	if (pathname.startsWith("/paid-advertisement")) {
		...
		data = {
			services: (socialMediaData as any).otherServices
				.socialMediaServices,
			slugMapping: (socialMediaData as any).otherServices
				.slugMapping,
		...
		data = {
			services: webDevelopmentData.otherServices
				.webdevelopmentServices,
			slugMapping:
				webDevelopmentData.otherServices.slugMapping,
		...
		data = {
			...
			slugMapping: (appDevelopmentData as any).otherServices
				.slugMapping,
			config: (appDevelopmentData as any).otherServices
				.config,
		}
	} else if (pathname.startsWith("/hosting-it-security")) {
		// Use hosting & IT security data
		data = {
			services: (hostingData as any).otherServices
				.hostingItSecurityServices,
			slugMapping: (hostingData as any).otherServices
				.slugMapping,
		...
		data = {
			services: (aiAutomationData as any).otherServices
				.aiAutomationServices,
			slugMapping: (aiAutomationData as any).otherServices
				.slugMapping,
		...
		data = {
			...
			slugMapping: (dataAnalyticsData as any).otherServices
				.slugMapping,
