...
const FALLBACK_IMAGES = [
  {
    id: "hero-one",
    image: "/ai-automation/heroOne.webp",
    alt: "AI Bot",
  },
  {
    id: "hero-two",
    image: "/ai-automation/heroTwo.webp",
    alt: "User 1",
  },
  {
    id: "hero-three",
    image: "/ai-automation/heroThree.webp",
    alt: "User 2",
  },
];
...
export default function AiAutomationHero({
  data,
  defaultImages,
}: AiAutomationHeroProps) {
  const heading = data?.heading || "AI & Automation Services";
  const subheading =
    data?.subheading ||
    "Transform your business with intelligent automation and cutting-edge AI solutions to streamline operations and boost productivity.";
      ...
      <div className="relative z-20 container mx-auto py-6 md:py-0 px-6 lg:px-12">
        <div className="relative flex items-center justify-center min-h-[70vh]">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            >
              <span style={{ color: "#5D50EB" }}>AI-First Development:</span>{" "}
              {heading}
            </motion.h1>
