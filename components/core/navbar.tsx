      ...
      columns: [
        {
          ...
          services: [
            ...
            {
              name: "AI-powered Voice Agents / Receptionists",
              icon: "🎤",
            },
            {
      ...
      columns: [
        {
          ...
          services: [
            ...
            {
              name: "Car Removal & Wreckers Marketing Agency",
              icon: "🚗",
            },
            {
              name: "Automotive Repair & Servicing Marketing Agency",
              icon: "🔧",
            },
            ...
            {
              name: "Movers & Relocation Services Marketing Agency",
              icon: "📦",
            },
            {
            ...
            {
              name: "Small Business Marketing Agency",
              icon: "🏪",
            },
            {
              name: "Medium Business Marketing Agency",
              icon: "🏢",
            },
            {
              name: "Enterprise Business Marketing Agency",
              icon: "🏭",
            },
        ...
        },
        {
          ...
          services: [
            ...
            {
              name: "Mortgage Broker Marketing Agency",
              icon: "💰",
            },
            {
              name: "Physiotherapists Marketing Agency",
              icon: "🏥",
            },
            {
              name: "Coaches Marketing Agency",
              icon: "🎯",
            },
            {
              name: "Law Firm Marketing Agency",
              icon: "⚖️",
            },
              ...
              <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-3">
                  <div className="space-y-1 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 pr-1">
                    {megaMenuData[
                      activeCategory as keyof typeof megaMenuData
                ...
                <div className="col-span-9">
                  <div
                    className={cn(
                      "grid gap-4",
                      megaMenuData[activeCategory as keyof typeof megaMenuData]
                        .columns.length === 5
                        ? "grid-cols-5"
                        : megaMenuData[
                              activeCategory as keyof typeof megaMenuData
                          ...
                          {column.services.map((service, serviceIndex) => (
                            <Link
                              ...
                              href={(() => {
                                ...
                                if (
                                  activeCategory === "Web & App Development" &&
                                  column.title === "Web Development"
                                ) {
                                ...
                                const dataAnalyticsSlugs = new Set([
                                  "data-analytics",
                                  "data-and-analytics",
                                ...
                                if (
                                  column.title === "Search Engine Optimisation"
                                ) {
                                  const mappedSlug =
                                  ...
                                  if (
                                    finalSlug === "search-engine-optimisation"
                                  ) {
                                    return "/seo";
                                  }
                                ...
                                if (dataAnalyticsSlugs.has(name)) {
                                ...
                                if (activeCategory === "AI & Automation") {
                                  const aiAutomationSlugMap: Record<
                                    ...
                                    string
                                  > = {
                                    "ai-assistants-chatbots": "ai-chatbots",
                                ...
                                if (activeCategory === "Industries") {
                                  ...
                                  if (
                                    professionalsMarketingServices.has(name)
                                  ) {
                                ...
                                if (
                                  activeCategory === "Web & App Development" &&
                                  column.title === "Hosting, IT & Security"
                                ) {
                                  const hostingSlugMap: Record<string, string> =
                                    {
                            ...
                            <div key={categoryKey}>
                              ...
                              {expandedMobileCategory === categoryKey && (
                                <div className="ml-4 space-y-2">
                                  {megaMenuData[
                                    categoryKey as keyof typeof megaMenuData
                                  ].columns.map((column) => (
